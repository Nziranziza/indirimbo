// Reanimated `sharedValue.value = ...` is the documented mutation API; React Compiler's
// static analysis flags it (and ref access in gesture callbacks) because it can't see
// Reanimated's escape hatch.
